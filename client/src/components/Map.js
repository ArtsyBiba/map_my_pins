...
const Map = ({ classes }) => {
	...
	// remove popup if pin was deleted by its author
	useEffect(
		() => {
	...
	return (
		<div className={mobileSize ? classes.rootMobile : classes.root}>
			<ReactMapGL
				...
				mapboxApiAccessToken="pk.eyJ1IjoiYXJ0c3liaWJhIiwiYSI6ImNrZndqOWU0cjFyOGoyc253YWxoa2Zzd2wifQ.kaZF7v2z0STvrvkKdgqwSA"
